...
const EVENTS = [
  {
    name: "Degamefi 2025",
    city: "Tbilisi",
    date: "2025-12-10T09:00:00.000Z", // Future Date
  ...
  },
  {
    ...
    city: "Singapore",
    date: "2025-12-20T09:00:00.000Z", // Future Date
    eventType: "Conference",
    description: "...",
    imageUrl:
  ...
  },
  {
    ...
    city: "Barcelona",
    date: "2026-01-15T09:00:00.000Z", // Future Date
    eventType: "Conference",
    description: "...",
    imageUrl:
      "https://images.unsplash.com/photo-1550528913-5a1be7b6cfad?w=800&h=400&fit=crop",
  },
  {
    name: "Blockchain Life 2025",
    city: "Dubai",
    date: "2026-02-28T10:00:00.000Z", // Future Date
    eventType: "Forum",
    description: "...",
    imageUrl:
  ...
  },
  {
    ...
    city: "London",
    date: "2026-03-22T09:30:00.000Z", // Future Date
    eventType: "Conference",
    description: "...",
    imageUrl:
...
function getLocationData(location: Prisma.JsonValue): {
  lat: number;
  lng: number;
  address: string;
} {
...
async function main() {
    ...
    await prisma.event.create({
      data: {
        ...
        location: {
          lat: coords.lat,
          lng: coords.lng,
          address: `Convention Center, ${ev.city}`,
  ...
  const ownerAccounts = [
    {
      email: "owner.tbilisi@fleet.ge",
      password: "owner123",
      company: "Tbilisi Shuttle Co",
    },
    {
      email: "owner.dubai@fleet.ae",
      password: "owner123",
      company: "Dubai Crypto Rides",
    },
  ];
  ...
  const driverAccounts = [
    {
      name: "Giorgi",
      email: "giorgi@fleet.ge",
      password: "driver123",
      license: "DRV-GEO-101",
    },
    {
      name: "Ahmed",
      email: "ahmed@fleet.ae",
      password: "driver123",
      license: "DRV-DXB-999",
    },
  ];
  ...
  // 5. Shuttles — assign drivers to multiple shuttles
  const vehicles = await prisma.vehicle.findMany();
  const events = await prisma.event.findMany({
    select: { id: true, eventDate: true, location: true },
  });
      ...
      data: {
        ...
        driverId:
          createdDrivers.length > 0
            ? createdDrivers[i % createdDrivers.length].id
            : undefined,
